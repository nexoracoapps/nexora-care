...
const PERMISSION_GROUPS: { group: string; groupAr: string; icon: string; color: string; items: PermItem[] }[] = [
  {
    ...
    items: [
      ...
      { key: 'sendBroadcasts',   icon: '📣', label: 'Broadcast Messages',          labelAr: 'إرسال رسائل جماعية',          parentKey: 'manageCustomers' },
    ],
  },
  {
  ...
  {
    group: 'Revenue', groupAr: 'الإيرادات', icon: '💰', color: '#059669',
    items: [
      { key: 'viewRevenue', icon: '💰', label: 'View Revenue & Distribution Page', labelAr: 'عرض صفحة الإيرادات والتوزيع' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      { key: 'systemBackup',   icon: '💾', label: 'System Backup',              labelAr: 'النسخ الاحتياطي' },
