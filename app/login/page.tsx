    ...
    <>
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        @media (max-width: 480px) {
          ...
          .lr-panel { border-radius: 20px; width: calc(100% - 24px); max-width: 100%; max-height: calc(100dvh - 24px); overflow-y: auto; -webkit-overflow-scrolling: touch; }
          .lr-root { align-items: center; justify-content: center; padding: 12px; }
      ...
      <div className="lr-root" dir={isAr ? 'rtl' : 'ltr'}>
        ...
        <div className="lr-panel">
          <div className="lr-form-inner">
            ...
            <div ref={themePickerRef} style={{ position:'relative', display:'flex', alignItems:'center', justifyContent:'center', gap:10, marginTop:20, marginBottom:16 }}>
